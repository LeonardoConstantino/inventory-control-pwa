...
export function List(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M4 17q-.425 0-.713-.288T3 16q0-.425.288-.713T4 15q.425 0 .713.288T5 16q0 .425-.288.713T4 17Zm0-4q-.425 0-.713-.288T3 12q0-.425.288-.713T4 11q.425 0 .713.288T5 12q0 .425-.288.713T4 13Zm0-4q-.425 0-.713-.288T3 8q0-.425.288-.713T4 7q.425 0 .713.288T5 8q0 .425-.288.713T4 9Zm3 8v-2h14v2H7Zm0-4v-2h14v2H7Zm0-4V7h14v2H7Z"
      ></path>
    </svg>
  );
}
...
export function Inventory(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M3 20V8.7q-.425-.275-.713-.7T2 7V4q0-.825.588-1.413T4 2h16q.825 0 1.413.588T22 4v3q0 .575-.288 1T21 8.7V20q0 .825-.588 1.413T19 22H5q-.825 0-1.413-.588T3 20ZM5 9v11h14V9H5Zm15-2V4H4v3h16ZM9 14h6v-2H9v2Zm-4 6V9v11Z"
      ></path>
    </svg>
  );
}

export function CurrencyReal(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function ArrowsLeftRight(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
